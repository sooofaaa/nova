...
define gui.about = _p("""
Благодраю за это, бомжа упавшего с небес и ударевший меня бутылкой в голову, теперь я одноглазая

Авторы: Софа, Родич и Ксюша
""")
...
define config.save_directory = "NovelaBeta-1690656866"
